...
function ChatMessageCompose({ send, sending }) {
    ...
    return (
        <div className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
            <form onSubmit={emitSend}>
                <div className="relative flex">
                    { sending && <span>Sending....</span> }
                    <input type="text" value={message} onChange={e => setMessage(e.target.value)} placeholder="Say something" className="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-4 bg-gray-200 rounded-md py-3" />
